...
import '../../../../models/request/bookmarks/all_bookmarks_model.dart';

class BookmarkTile extends StatelessWidget {
  final void Function()? onTap;
  final Job job;
  const BookmarkTile({super.key, this.onTap, required this.job});
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ReusableText(
                            text: job.title,
                            style: appstyle(
                                18.sp, Color(kDarkGrey.value), FontWeight.w600),
                          ),
                        ),
                      ],
                    ),
